    ...
    <div className="fixed top-0 left-1/2 transform -translate-x-1/2 pt-20 w-5/6 lg:w-3/4">
      <section className="border border-gray-300 shadow-lg p-6">
        ...
        {/* <p>
          ...
          friend and joining in on the Carnaval fun - especially the "festa da
          rua" (street party) in February of 2023. One year later I moved to
          Brasil, and have been here for ~3 months now.
        </p> */}
      </section>
    </div>
  );
